...
const MainHeader = () => {
  return (
    ...
    >
      <div
        id="NavBar"
        className="flex w-full flex-row justify-between p-3 font-mono text-sm "
      >
        ...
        <div id="SignInButtons" className="flex flex-row">
          <button
            className="me-6 rounded-lg bg-slate-600 hover:bg-blue-700"
            onClick={toSignup}
          >
            Signup
          </button>
          <button
            className="rounded-lg bg-slate-600 hover:bg-blue-700"
            onClick={toLogin}
          >
            Login
          </button>
